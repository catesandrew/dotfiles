...
# cat $htmlinput | pandoc --unicode-snob --body-width=0 --dash-unordered-list >| "./${HTML_FILE}.tex"
pandoc --standalone $htmlinput --output "./${HTML_FILE}.tex"

# cat $htmlinput | pandoc --wrap=none --standalone >| "./${HTML_FILE}.tex"
