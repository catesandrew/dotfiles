...
if brew_contains_element "zoxide" || \
  ...
  # Custom options to pass to fzf during interactive selection. See man fzf for
  # the list of options. export _ZO_FZF_OPTS
  ...
  # Hook into precmd functions
  if ! contains_element __zoxide_hook "${precmd_functions[@]}"; then
